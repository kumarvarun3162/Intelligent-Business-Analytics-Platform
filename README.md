...
Django backend receives and stores the dataset

Pandas cleans and preprocesses the data

Cleaned data is stored in MySQL

Data is made available for Power BI dashboards
